...
(async () => {
    ...
    // verifica se a variavel logoText contem o texto 'conduit'

    const logoHref = await page.$eval('.navbar-brand', el => el.href)
    expect(logoHref).toBeDefined()
    // verifica se a variavel logoHref foi definida
    ...
    // expect com not tomatch espera que dentro href não tenha a url
